...
- status: **registered**, registered 2026-08-06, universe 40 names, hold 5 sessions, cost 0.1% round trip
- graded signals: **52** (need 30) over **23** distinct names (need 20); single pre-declared verdict date **2026-11-02**
- day-matched excess, 1 session: mean **+0.185%**, median **+0.095%**, 10% trimmed **+0.094%**, clustered 95% CI [-0.106, +0.573] over 23 names
- day-matched excess, 5 sessions: mean **+0.126%**, median **-0.113%**
- win rate 46% *(reported only — not a pass criterion)*
- **read: accruing — 52/30 graded signals over 23/20 distinct names. **No verdict is computed before the single pre-declared verdict date of 2026-11-02**, and none is computed then unless both floors are met.**
...
- status: **registered**, registered 2026-08-06, universe 40 names, hold 5 sessions, cost 0.1% round trip
- graded signals: **8** (need 30) over **5** distinct names (need 20); single pre-declared verdict date **2026-11-02**
- day-matched excess, 1 session: mean **-0.358%**, median **-0.038%**, 10% trimmed **-0.358%**, clustered 95% CI n/a
- day-matched excess, 5 sessions: mean **-2.235%**, median **-2.363%**
- win rate 25% *(reported only — not a pass criterion)*
- **read: accruing — 8/30 graded signals over 5/20 distinct names. **No verdict is computed before the single pre-declared verdict date of 2026-11-02**, and none is computed then unless both floors are met.**
...
- day-matched excess, 1 session: mean **+0.085%**, median **+0.052%**, 10% trimmed **+0.059%**, clustered 95% CI [-0.170, +0.362] over 27 names
- day-matched excess, 5 sessions: mean **+0.545%**, median **+0.641%**
