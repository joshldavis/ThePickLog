# ThePickLog — experiments under test · 2026-08-28
...
- graded signals: **19** (need 30) over **16** distinct names (need 20); single pre-declared verdict date **2026-11-02**
- day-matched excess, 1 session: mean **-0.093%**, median **-0.209%**, 10% trimmed **-0.088%**, clustered 95% CI [-0.746, +0.577] over 16 names
- day-matched excess, 5 sessions: mean **+0.051%**, median **-1.178%**
- win rate 47% *(reported only — not a pass criterion)*
- **read: accruing — 19/30 graded signals over 16/20 distinct names. **No verdict is computed before the single pre-declared verdict date of 2026-11-02**, and none is computed then unless both floors are met.**
...
- status: **registered**, registered 2026-08-06, universe 40 names, hold 5 sessions, cost 0.1% round trip
- graded signals: **26** (need 30) over **15** distinct names (need 20); single pre-declared verdict date **2026-11-02**
- day-matched excess, 1 session: mean **+0.187%**, median **-0.036%**, 10% trimmed **+0.118%**, clustered 95% CI [-0.293, +0.862] over 15 names
- day-matched excess, 5 sessions: mean **+1.235%**, median **+0.628%**
- win rate 50% *(reported only — not a pass criterion)*
- **read: accruing — 26/30 graded signals over 15/20 distinct names. **No verdict is computed before the single pre-declared verdict date of 2026-11-02**, and none is computed then unless both floors are met.**
