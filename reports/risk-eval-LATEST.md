# ThePickLog — H-RISK1 / H-RISK2 forward evaluation · 2026-08-24
...
- score -> |MAE| (drawdown depth): rho=-0.001 CI[-0.147,+0.134] n=167 tickers=16 ns
- score -> range (MFE-MAE): rho=+0.199 CI[+0.051,+0.312] n=167 tickers=16 SIG
- score -> same-day return *(must stay ns)*: rho=-0.049 CI[-0.212,+0.110] n=167 tickers=16 ns
- score -> 5-day return *(must stay ns)*: rho=+0.116 CI[-0.045,+0.255] n=167 tickers=16 ns
...
- score -> |MAE| (drawdown depth): rho=+0.179 CI[-0.005,+0.355] n=120 tickers=110 ns
- score -> range (MFE-MAE): rho=+0.281 CI[+0.091,+0.457] n=120 tickers=110 SIG
- score -> same-day return *(must stay ns)*: rho=+0.106 CI[-0.085,+0.297] n=120 tickers=110 ns
- score -> 5-day return *(must stay ns)*: rho=-0.140 CI[-0.330,+0.056] n=120 tickers=110 ns
- consecutive weekly snapshots with positive |MAE| rho: **3** (need >= 3)
...
- Brier (frozen model) **0.1843** vs no-skill baseline **0.1825** -> does NOT beat baseline
- realised P(MAE <= -20%): Q1 20.9% vs Q5 22.2%
- Q5-Q1 gap: 1.3% (need >= 15%) -> not met
- per-quintile realised / predicted / n:

  - Q1: realised 20.9% · predicted 20.2% · n=43
  - Q2: realised 24.0% · predicted 39.6% · n=25
  - Q3: realised 14.7% · predicted 34.9% · n=34
  - Q4: realised 14.9% · predicted 38.2% · n=47
  - Q5: realised 22.2% · predicted 48.3% · n=18
