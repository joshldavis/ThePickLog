# ThePickLog — Morning Brief · 2026-07-07
...
- **BJDX** (tier A, score 100.0) — very high relative volume (22×); thin float (0.9M); large up-gap (+38%). Watch level (reference only, +20%): $1.92.  ⚠️ **Finding A — runs hot:** highest-momentum tier; historically the *deepest* drawdowns. Hardest to hold.
- **SUGP** (tier A, score 84.9) — very high relative volume (11×); thin float (1.2M). Watch level (reference only, +20%): $1.068.  ⚠️ **Finding A — runs hot:** highest-momentum tier; historically the *deepest* drawdowns. Hardest to hold.
- **HKIT** (tier C, score 49.4) — thin float (0.0M). Watch level (reference only, +20%): $4.812.
- **NCT** (tier C, score 46.2) — thin float (0.4M). Watch level (reference only, +20%): $3.3014.
- **VMAR** (tier D, score 43.6) — thin float (0.1M). Watch level (reference only, +20%): $1.686.
...
- Across **180** graded picks, the **hottest momentum tier (A/B) draws down deeper**: median worst-dip **-21%** (rug rate 27%) vs **-14%** (rug 12%) for C/D.
