# IgnitionScan — Morning Brief · 2026-07-01
...
- **CUPR** (tier A, score 91.7) — elevated relative volume (7.6×); thin float (0.9M); large up-gap (+48%). Watch level (reference only, +20%): $7.908.  ⚠️ **Finding A — runs hot:** highest-momentum tier; historically the *deepest* drawdowns. Hardest to hold.
- **BJDX** (tier B, score 63.3) — thin float (0.9M); large down-gap (-17%). Watch level (reference only, +20%): $1.44.  ⚠️ **Finding A — runs hot:** highest-momentum tier; historically the *deepest* drawdowns. Hardest to hold.
- **GCDT** (tier C, score 50.7) — screened on the published criteria. Watch level (reference only, +20%): $0.6828.
- **IOTR** (tier C, score 49.3) — thin float (0.6M). Watch level (reference only, +20%): $2.748.
- **SVRN** (tier C, score 47.7) — thin float (0.6M). Watch level (reference only, +20%): $9.396.
...
- Across **135** graded picks, the **hottest momentum tier (A/B) draws down deeper**: median worst-dip **-20%** (rug rate 26%) vs **-15%** (rug 13%) for C/D.
