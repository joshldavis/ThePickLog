...
- **VMAR** (tier A, score 95.5) — very high relative volume (38×); thin float (0.1M); large down-gap (-16%). Watch level (reference only, +20%): $1.896.  ⚠️ **Finding A — runs hot:** highest-momentum tier; historically the *deepest* drawdowns. Hardest to hold.
- **RKDA** (tier C, score 53.0) — thin float (1.8M). Watch level (reference only, +20%): $0.8988.
- **CUPR** (tier C, score 52.4) — thin float (0.9M). Watch level (reference only, +20%): $7.152.
- **NCT** (tier D, score 44.7) — thin float (0.4M). Watch level (reference only, +20%): $3.768.
- **IOTR** (tier D, score 44.7) — thin float (0.6M). Watch level (reference only, +20%): $3.024.
...
- Across **150** graded picks, the **hottest momentum tier (A/B) draws down deeper**: median worst-dip **-20%** (rug rate 26%) vs **-15%** (rug 13%) for C/D.
